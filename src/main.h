...
#define START_MASTERNODE_PAYMENTS_TESTNET 1517685900 // Saturday, February 3, 2018 7:25:00 PM
...
static const unsigned int MAX_BLOCK_SIZE = 85673194; // 85 megabyte blocks
/** Default for -blockmaxsize and -blockminsize, which control the range of sizes the mining code will create **/
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = MAX_BLOCK_SIZE/2;
...
public:
    ...
    {
#ifndef LOWMEM
        return strprintf("CBlockIndex(pprev=%p, nHeight=%d, nMint=%s, nFlags=(%s)(%d)(%s), nStakeModifier=%016x, prevoutStake=(%s), nStakeTime=%d, merkle=%s, hashBlock=%s)",
#else
        return strprintf("CBlockIndex(pprev=%p, nHeight=%d, nFlags=(%s)(%d)(%s), nStakeModifier=%016x, prevoutStake=(%s), nStakeTime=%d, merkle=%s, hashBlock=%s)",
#endif
            pprev, nHeight,
#ifndef LOWMEM
            FormatMoney(nMint),
...
#ifndef LOWMEM
        READWRITE(VARINT(bnStakeModifierV2));
#endif
        if (IsProofOfStake())
        {
